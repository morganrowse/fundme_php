        ...
        <div class="row">
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    {{Form::open(['action'=>'ApplicationController@handleCreate','method'=>'POST','class'=>'form-horizontal','role'=>'form'])}}
                    ...
                    <div class="form-group{{ $errors->has('funding_type') ? ' has-error has-feedback' : '' }}">
                        ...
                        <div class="col-md-6">
                            {{Form::select('funding_type',$funding_types,old('funding_type'),['class'=>'form-control','autofocus','placeholder'=>trans('string.please_select')])}}
                    ...
                    <div class="form-group{{ $errors->has('amount') ? ' has-error has-feedback' : '' }}">
                        ...
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                {{Form::number('amount',old('amount'),['class'=>'form-control','placeholder'=>'0.00','min'=>'0','step'=>'0.01'])}}
                            </div>
