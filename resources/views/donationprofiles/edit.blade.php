@section('title') {{trans('string.edit_donation_profile')}} @endsection
        ...
        <div class="card card-outline-warning">
            ...
            <div class="card-block">
                <div class="col-lg-8 offset-lg-2">
                    {{Form::open(['action'=>array('DonationProfileController@handleEdit',$donation_profile->id),'method'=>'POST'])}}
                    ...
                    <div class="form-group row{{$errors->has('donor') ? ' has-danger' : '' }}">
                        ...
                        <div class="col-lg-8">
                            {{Form::select('donor',$donors,$donation_profile->donor_id,['class'=>'form-control','placeholder'=>trans('string.please_select'),'autofocus'])}}
                            @if($errors->has('donor'))
                    ...
                    <div class="form-group row{{$errors->has('funding_type') ? ' has-danger' : '' }}">
                        ...
                        <div class="col-lg-8">
                            {{Form::select('funding_type',$funding_types,$donation_profile->funding_type_id,['class'=>'form-control','placeholder'=>trans('string.please_select')])}}
                    ...
                    <div class="form-group row{{$errors->has('financial_means') ? ' has-danger' : '' }}">
                        ...
                        <div class="col-lg-8">
                            {{Form::select('financial_means',$financial_means,$donation_profile->financial_means,['class'=>'form-control','placeholder'=>trans('string.please_select')])}}
                    ...
                    <div class="form-group row{{$errors->has('maximum_amount') ? ' has-danger' : '' }}">
                        ...
                        <div class="col-lg-8">
                            <div class="input-group">
                                ...
                                {{Form::number('maximum_amount',Fundme::getCurrency($donation_profile->maximum_amount),['class'=>'form-control','placeholder'=>trans('placeholder.amount'),'step'=>'0.01','min'=>'0.00'])}}
                            </div>
